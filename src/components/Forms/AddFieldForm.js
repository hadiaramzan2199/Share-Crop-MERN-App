...
const AddFieldForm = ({ onFieldAdded, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const fieldData = {
        ...
        latitude: 40.7128 + (Math.random() - 0.5) * 0.1, // Random location near NYC for demo
      ...
      const newField = storageService.addFarmerField(fieldData);
      ...
      if (newField) {
        ...
        alert('Failed to add field. Please make sure you are logged in as a farmer.');
      }
    } catch (error) {
